...
router.route("/:videoId").get(getVideoComments).post(verifyJWT,upload.none(),addComment);
router.route("/c/:commentId").delete(verifyJWT,deleteComment).patch(verifyJWT, upload.none(), updateComment);
